...
const VERSION = 'drill-v0.3.1';
const FILES = ['./', './index.html', './app.js', './order.js', './merge.js', './manifest.webmanifest', './data/drill-words.json', './icons/icon.svg', './icons/icon-192.png', './icons/icon-512.png', './icons/icon-180.png'];
