...
const VERSION = 'drill-v0.2.4';
const FILES = ['./', './index.html', './app.js', './order.js', './manifest.webmanifest', './data/drill-words.json', './icons/icon.svg', './icons/icon-192.png', './icons/icon-512.png', './icons/icon-180.png'];
